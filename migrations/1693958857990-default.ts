...
export class Default1693958857990 implements MigrationInterface {
    name = 'Default1693958857990'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rents" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "ownerevaluation" integer NOT NULL, "clientevaluation" integer NOT NULL, "idbike" integer, "iduser" integer, CONSTRAINT "PK_43a9961f1448a8d75f9b25156ea" PRIMARY KEY ("id"))`);
