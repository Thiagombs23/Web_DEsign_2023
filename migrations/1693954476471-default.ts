...
export class Default1693954476471 implements MigrationInterface {
    name = 'Default1693954476471'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "bikes" DROP COLUMN "gender"`);
        await queryRunner.query(`CREATE TYPE "public"."bikes_gender_enum" AS ENUM('male', 'female', 'unissex')`);
