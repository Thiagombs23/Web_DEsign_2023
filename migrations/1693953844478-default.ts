...
export class Default1693953844478 implements MigrationInterface {
    name = 'Default1693953844478'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bikes" ("id" SERIAL NOT NULL, "color" character varying(30) NOT NULL, "size" character varying(10) NOT NULL, "material" character varying(20) NOT NULL, "gender" character varying(10) NOT NULL, "speedkit" character varying(10) NOT NULL, "aro" integer NOT NULL, "suspensao" boolean NOT NULL, "hourlyvalue" integer NOT NULL, "dailyvalue" integer NOT NULL, "description" character varying(200) NOT NULL, CONSTRAINT "PK_5237c1fcb162998a0d31e640814" PRIMARY KEY ("id"))`);
    }
